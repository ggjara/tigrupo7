...
def getAlmacenes
	almacenes = Array.new
  jsonAlmacenes = requestWeb('GET', ENV["url_bodega"]+"almacenes")
...
def getSkusWithStock(almacen_id)
	...
	jsonSkusWithStock = requestWeb('GET', ENV["url_bodega"]+"skusWithStock",
...
def getStock(almacen_id, sku, limit)
	...
	jsonProducts = requestWeb('GET', ENV["url_bodega"]+"stock",
...
def moverStock(producto_id, almacen_id) #CHECK & V
  jsonMoverStock = requestWeb('POST', ENV["url_bodega"]+"moveStock",
...
def moverStockBodega(producto_id, almacen_id, oc_id, precio) #CHECK
  jsonMoverStockBodega = requestWeb('POST', ENV["url_bodega"]+"moveStockBodega",
...
def producirStock(sku, cantidad, trx_id) #CHECK
  jsonProducirStock = requestWeb('PUT', ENV["url_bodega"]+"fabrica/fabricar",
...
def getCuentaFabrica #CHECK
    jsonCuentaFabrica = requestWeb('GET', ENV["url_bodega"]+"fabrica/getCuenta")
